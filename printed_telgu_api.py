...
# to run `uvicorn printed_telgu_api:app --reload`

# to open swagger for the api `http://127.0.0.1:8000/docs`

# "http://bhasha.iiit.ac.in/bhashini-iiith/static/ulca_examples/telugu_word_image1.jpg"
...
def initialize_handwritten_models():
    ...
    #Recognition model
    reco_model = crnn_vgg16_bn(pretrained=False, vocab= '౦ఱకఆఋడత౯౻ిహౌ౭౽ఉ౮్ధఓగ౼మ౫ూౠఔాఇనైఁజీౄుేసశృఃఝఢరఠలోఞౘఅ౹౧ౢఛబ౸ఐయ౩ఖటచెొఊదఈషథభఏౙ౬౾ఎ౪ణఒప౨ఫంఘఙళవ౺-')
    reco_param = torch.load(r'E:\IITB_OCR\crnn_vgg16_bn_printed-telugu.pt', map_location="cpu")
