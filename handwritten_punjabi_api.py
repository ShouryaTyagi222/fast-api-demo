...
def initialize_handwritten_models():
    ...
    #Recognition model
    reco_model = crnn_vgg16_bn(pretrained=False, vocab= 'ਗ਼ਵਨਁਰਊਖਂਆਜੈਲੴਣ੧ਛਭਫ੮੯ਚਔੀਯਹਲ਼ਞ੩ੜਫ਼ੁਮ੫ਤੇਦਸ਼ਟੰ੭ਓਅਃਡਾਉਠੱਈ੦ੵਖ਼ਏਕਥ੬ਧੲੑਝਿ੨ਐਬਪਘਸ਼ਙੌਜ਼ੋਗ੍ੳਇ੪ੂਢ-।')
    reco_param = torch.load(r'E:\IITB_OCR\crnn_vgg16_bn_handwritten_gurumukhi.pt', map_location="cpu")
