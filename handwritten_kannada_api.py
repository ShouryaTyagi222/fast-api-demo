...
# to run `uvicorn handwritten_kannada_api:app --reload`

# to open swagger for the api `http://127.0.0.1:8000/docs`

# https://imgv2-1-f.scribdassets.com/img/document/54856543/original/5d2ab92ebc/1627133670?v=1
...
def initialize_handwritten_models():
    ...
    #Recognition model
    reco_model = crnn_vgg16_bn(pretrained=False, vocab= 'ಚೕಒಉೖಂಲಾಝಟೆಅ೬ೇ೨ಬಡವಜಢಞಔಏಧಶಭತಳೀಕಐಈಠಪ೫ಣ೮ೞಆಯುಗೢಋದಘೂ್ೈ೦ಓಱಃಹ೯ೋಮ೭ೠಥಖಫಇರ೪ಛಙೣಿ೩ೌೄಷಌಸನ಼ಊಎ೧ೃೊ-')
    reco_param = torch.load(r'E:\IITB_OCR\crnn_vgg16_bn_handwritten_kannada.pt', map_location="cpu")
